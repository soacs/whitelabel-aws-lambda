    ...
    var dbResponse = docClient.get(params, function(err, data) {
        ...
        if (err) {
            ...
            if (data !== undefined) {
                ...
                console.log("getFirmConfigData: " + JSON.stringify(accountCreateConfigData));
                
                if (httpMethod === "GET") {
                    responseBody = JSON.stringify(accountCreateConfigData);
                } else {
                ...
                console.log("END: getAccountCreateConfig");
            }
        }
