...
var questionnaireConfigTableName = 'QuestionnaireConfig';
...
exports.handler = (event, context, callback) => {
    ...
    var params = {
        TableName: questionnaireConfigTableName,
        Key: {
            brand: brand
        }
    };
    ...
    var dbResponse = docClient.get(params, function(err, data) {
        ...
        if (err) {
            ...
            if (data !== undefined) {
                questionnaireConfigData = data.Item;
                console.log("questionnaireConfigData: " + JSON.stringify(questionnaireConfigData));
                
                if (httpMethod === "GET") {
                    responseBody = JSON.stringify(questionnaireConfigData);
                } else {
                     responseBody = questionnaireConfigData;
                }
